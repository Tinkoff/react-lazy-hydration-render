...
describe('ProgressiveRenderer', () => {
  beforeEach(() => {
    document.body.innerHTML =
      '<div id="root"><div style="display:contents"><section><h1>Original markup</h1></section></div></div>';
  });
  ...
  it('it render original markup', () => {
    ...
    expect(root.innerHTML).toMatchInlineSnapshot(
      `"<div style=\\"display:contents\\"><section><h1>Original markup</h1></section></div>"`
    );
  });
  ...
  it('custom observer mechanism', async () => {
    ...
    expect(root.innerHTML).toMatchInlineSnapshot(
      `"<div style=\\"display:contents\\"><section><h1>Original markup</h1></section>Custom text</div>"`
    );
  });
